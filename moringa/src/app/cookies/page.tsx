...
export default function CookiesPage() {
  ...
  const content = {
    en: { title: 'Cookie Policy', lastUpdated: 'Last updated: November 2, 2025' },
    ar: { title: 'سياسة ملفات تعريف الارتباط', lastUpdated: 'آخر تحديث: 2 نوفمبر 2025' },
    he: { title: 'מדיניות עוגיות', lastUpdated: 'עודכן לאחרונה: 2 בנובמבר 2025' }
  };
    ...
    <div className="min-h-screen bg-[hsl(var(--background))] py-6" dir={language === 'ar' || language === 'he' ? 'rtl' : 'ltr'}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-[hsl(var(--card))] rounded-lg p-6 border border-[hsl(var(--border))]">
          <p className="text-[hsl(var(--muted-foreground))]">Cookie Policy content will be added here.</p>
        </div>
      </div>
    </div>
  );
