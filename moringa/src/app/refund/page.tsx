...
export default function RefundPage() {
  ...
  const content = {
    en: { title: 'Refund Policy', lastUpdated: 'Last updated: November 2, 2025' },
    ar: { title: 'سياسة الاسترجاع', lastUpdated: 'آخر تحديث: 2 نوفمبر 2025' },
    he: { title: 'מדיניות החזרות', lastUpdated: 'עודכן לאחרונה: 2 בנובמבר 2025' }
  };
    ...
    <div className="min-h-screen bg-[hsl(var(--background))] py-6" dir={language === 'ar' || language === 'he' ? 'rtl' : 'ltr'}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-[hsl(var(--card))] rounded-lg p-6 border border-[hsl(var(--border))]">
          <p className="text-[hsl(var(--muted-foreground))]">Refund Policy content will be added here.</p>
        </div>
      </div>
    </div>
  );
